						...
						<form action="" method="post" id="fileForm" role="form">
							<fieldset>
								...
								<div class="form-group">
									<label for="nompart"><span class="req">* </span> Nom: </label> <input required type="text" name="nomassos"
										id="nompart" class="form-control nompart" maxlength="200"
									...
									<div class="col-xs-6">
										<div class="form-group">
											<input class="btn btn-success" type="submit"
												name="submit_reg" value="Créer un compte">
