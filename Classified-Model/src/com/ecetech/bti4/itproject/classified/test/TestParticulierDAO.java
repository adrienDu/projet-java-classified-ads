...
public class TestParticulierDAO {
	...
	public void testAddPartUser() {
		...
		ParticulierDAO userDAO = new ParticulierDAO();
		try {
			userDAO.addPartUser("claireralou@mail.com", "CR123", "classique", "Claire", "Ralou", 34, "Rue des glycines",
					75017, "Paris", 0342422312);
		} catch (SQLException e) {
			e.printStackTrace();
			System.out.println("erreur de connexion");
		}
	...
	@Test
	/**
	 * Test UpdatePrenomPart
	 */
	public void TestUpdatePrenomPart() {
		System.out.println("modifier le nom d'une personne");
		ParticulierDAO userDAO = new ParticulierDAO();
		try {
			userDAO.updatePrenomPart("P1", "L�a");
		} catch (SQLException e) {
			e.printStackTrace();
			System.out.println("erreur de connexion");
		}
