...
public class UserDAO {
	...
	**/
	public static void deleteUser(String idUser) throws SQLException {
		...
		try {
			DBAction.getStm().executeUpdate(req);
			System.out.println("L'utilisateur ayant l'id=" + idUser + " a bien �t� supprim�.");
		} catch (SQLException ex) {
			System.out.println(req);
			System.out.println("Requ�te non valide " + ex.getErrorCode());
		}
	...
	**/
	public static void updateMailUser(String idUser, String mailUser) throws SQLException {
		...
		try {
			DBAction.getStm().executeUpdate(req);
			System.out.println("Le mail de l'utilisateur ayant l'id=" + idUser + " a bien �t� modifi�.");
		} catch (SQLException ex) {
			System.out.println(req);
			System.out.println("Requ�te non valide " + ex.getErrorCode());
		}
	...
	**/
	public static void updateMdpUser(String idUser, String mdpUser) throws SQLException {
		...
		try {
			DBAction.getStm().executeUpdate(req);
			System.out.println("Le mot de passe de l'utilisateur ayant l'id=" + idUser + " a bien �t� modifi�.");
		} catch (SQLException ex) {
			System.out.println(req);
			System.out.println("Requ�te non valide " + ex.getErrorCode());
		}
	...
	**/
	public static void updateEtatUser(String idUser, String etatUser) throws SQLException {
		...
		try {
			DBAction.getStm().executeUpdate(req);
			System.out.println("L'�tat de l'utilisateur ayant l'id=" + idUser + " a bien �t� modifi�.");
		} catch (SQLException ex) {
			System.out.println(req);
			System.out.println("Requ�te non valide " + ex.getErrorCode());
		}
	...
	**/
	public static void updateTypeUser(String idUser, String typeUser) throws SQLException {
		...
		try {
			DBAction.getStm().executeUpdate(req);
			System.out.println("Le type de l'utilisateur ayant l'id=" + idUser + " a bien �t� modifi�.");
		} catch (SQLException ex) {
			System.out.println(req);
			System.out.println("Requ�te non valide " + ex.getErrorCode());
		}
	...
	**/
	public static void updatePermissionUser(String idUser, String permissionUser) throws SQLException {
		...
		try {
			DBAction.getStm().executeUpdate(req);
			System.out.println("Les permissions de l'utilisateur ayant l'id=" + idUser + " ont bien �t� modifi�es.");
		} catch (SQLException ex) {
			System.out.println(req);
			System.out.println("Requ�te non valide " + ex.getErrorCode());
		}
